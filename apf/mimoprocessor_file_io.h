    ...
    , const std::string& outfilename)
{
  ...
  Matrix<float> m_in(blocksize, in.channels());
  Matrix<float> m_in_transpose(in.channels(), blocksize);
  Matrix<float> m_out(blocksize, processor.out_channels());
  Matrix<float> m_out_transpose(processor.out_channels(), blocksize);
